...
const GeneratePdfTempIRN = ({ row, callBackFunction }) => {
  ...
  const handleDownloadPdf = async () => {
    ...
    if (input) {
      ...
      pdf.save(`IRN-Credit_Note_${row.docId}.pdf`);
      ...
      <DialogContent>
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              <div>
                <strong>Doc ID:</strong> {row.docId}
              </div>
              <div>
                <strong>Doc Date:</strong> {row.docDate}
              </div>
              <div>
                <strong>Ref. No. / Dt.:</strong> {row.originBillNo}
              </div>
              <div>
                <strong>Supp Bill No. / Dt.</strong> {row.supplierRefNo}
              </div>
              <div>
                <strong>Bill Cur:</strong> {row.billCurr}
              </div>
              <div>
                <strong>Ex Rate:</strong> {row.billCurrRate}
              </div>
              {/* <div>
          ...
          {/* <div style={styles.container}>
            ...
            <span style={styles.text}>Intra State GST</span>
          ...
          >
            <thead>
              <tr style={{ backgroundColor: '#673ab7', color: '#fff' }}>
                ...
                <th style={{ border: '1px solid #000000', padding: '10px' }}>Taxable</th>
                <th style={{ border: '1px solid #000000', padding: '10px' }}>Ex Rate</th>
                <th style={{ border: '1px solid #000000', padding: '10px' }}>FC Amount</th>
                <th style={{ border: '1px solid #000000', padding: '10px' }}>Taxable (LC)</th>
                <th style={{ border: '1px solid #000000', padding: '10px' }}>Non Taxable</th>
                <th style={{ border: '1px solid #000000', padding: '10px' }}>Bill Amount</th>
              </tr>
            </thead>
            <tbody>
              {row.irnCreditNoteDetailsVO?.map((item, index) => (
                <tr key={index} style={{ borderBottom: '1px solid #000000' }}>
                  ...
                  <td style={{ border: '1px solid #000000', padding: '10px' }}>{item.taxable}</td>
                  ...
                  <td style={{ border: '1px solid #000000', padding: '10px' }}>{item.lcAmount}</td>
                  <td style={{ border: '1px solid #000000', padding: '10px' }}>{item.billAmount}</td>
                </tr>
              ))}
            </tbody>
          </table>
